          ...
          <TouchableOpacity
            ...
            <View style={styles.flexRow}>
              <View style={styles.rowStart}>
                <Text style={styles.textColor14}>{"Terms and conditions"}</Text>
              </View>
              <MaterialIcons
                name="navigate-next"
                size={24}
        ...
        <View style={[styles.UnitSubContainer, Shadow.shadowStyle]}>
          <ScrollView showsVerticalScrollIndicator={false} bounces={false}>
            <Text style={styles.text2}>
              Weather app is the most helping app for the people who are mostly
              on travel and here we built this app for your ease. It provides
              you the best and accurate forecast prediction globally. Here you
              will get the 7 days forecast in just few minutes. Along with it,
              you can check it on hourly basis too. Another reliable option is
              providing the accurate timing of Sun rise and sun set. Humidity
              air quality, UV index and quick temperature check are also
              measured by this app. Prior warnings of weather also pop-up as
              news in this app.
            </Text>
          </ScrollView>
        </View>
